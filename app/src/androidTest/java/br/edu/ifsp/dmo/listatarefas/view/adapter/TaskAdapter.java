...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public ViewHolder on CreateViewHolder(@NonNull ViewGroup parent, int viewType){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.doneImageView.setOnClickListener(view -> listener.clickTaskDone(position));
    }
    @Override
